...
[![Release](https://img.shields.io/badge/release-0.2.0a14-blue)](https://github.com/abhilashsblai/ctxlayer-release/releases/tag/v0.2.0a14)
...
`0.2.0a13` introduced the updater bootstrap, and `0.2.0a14` repairs legacy-only
project migration. Install `0.2.0a14` once on machines without the updater.
...
See the full release notes for the exact v0.2.0a14 scope and caveats:
[docs/releases/v0.2.0a14.md](docs/releases/v0.2.0a14.md).

## Latest Release

Latest wheel: `ctxlayer-0.2.0a14-py3-none-any.whl`

New build: July 12, 2026 from the Advanced CTX Layer `v0.2.0a14` source tag.
