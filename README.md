...
[![Release](https://img.shields.io/badge/release-0.2.0a13-blue)](https://github.com/abhilashsblai/ctxlayer-release/releases/tag/v0.2.0a13)
...
`0.2.0a13` is the updater-adoption release. Install this wheel once on machines
running `0.2.0a12` or older. After that, update from each CTX-enabled project:
...
See the full release notes for the exact v0.2.0a13 scope and caveats:
[docs/releases/v0.2.0a13.md](docs/releases/v0.2.0a13.md).

## Latest Release

Latest wheel: `ctxlayer-0.2.0a13-py3-none-any.whl`

New build: July 12, 2026 from the Advanced CTX Layer `v0.2.0a13` source tag.
