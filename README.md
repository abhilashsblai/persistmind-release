...
[![Release](https://img.shields.io/badge/release-0.2.0a15-blue)](https://github.com/abhilashsblai/ctxlayer-release/releases/tag/v0.2.0a15)
...
project migration, and `0.2.0a15` repairs candidate installation from the
content-addressed wheel cache. Install `0.2.0a15` once on older machines.
...
See the full release notes for the exact v0.2.0a15 scope and caveats:
[docs/releases/v0.2.0a15.md](docs/releases/v0.2.0a15.md).

## Latest Release

Latest wheel: `ctxlayer-0.2.0a15-py3-none-any.whl`

New build: July 12, 2026 from the Advanced CTX Layer `v0.2.0a15` source tag.
